#!/bin/bash
# eks_rds_app_scaffold.sh
# One-stop scaffold: Terraform infra (VPC, EKS, RDS) + Kubernetes Node.js app with LoadBalancer

set -e

echo "🚀 Generating Terraform project: VPC + EKS + RDS + Node.js App"
