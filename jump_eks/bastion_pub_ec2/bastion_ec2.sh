...
# Scaffolds Terraform for: Custom VPC + Bastion Host (with IAM role + tools) + EKS (2-node fixed cluster)

set -e

echo "🚀 Generating Terraform project: VPC + Bastion (with IAM role + tools) + EKS"
